...
public class ModBlocks {
    ...
    public static final  Block SUPPORTER = registerBlock(new SupporterBlock(AbstractBlock.Settings.create().mapColor(MapColor.CYAN).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1323123.5F, 1321236.5F).sounds(BlockSoundGroup.LANTERN)), "supporter");
