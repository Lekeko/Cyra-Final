...
public class ModBlocks {
    ...
    public static final  Block BIOLUMINESCENCE_PREASSURE_PLATE = registerBlock(new PressurePlateBlock(BlockSetType.OAK, AbstractBlock.Settings.copy(Blocks.OAK_PRESSURE_PLATE)), "BIOLUMINESCENCE_PREASSURE_PLATE".toLowerCase(), new Item.Settings());
    ...
    public static final  Block DAZED_BIOLUMINESCENCE_PREASSURE_PLATE = registerBlock(new PressurePlateBlock(BlockSetType.OAK, AbstractBlock.Settings.copy(Blocks.OAK_PRESSURE_PLATE)), "DAZED_BIOLUMINESCENCE_PREASSURE_PLATE".toLowerCase(), new Item.Settings());
