...
public class ModBlocks {
    ...
    public static final  Block SEA_CRYSTAL_BRICK = registerBlock(new Block(Block.Settings.create().strength(10.0F, 200.0F).requiresTool()), "sea_crystal_brick");
    ...
    public static final  Block DEEP_SEA_LANTERN = registerBlock(new Block(AbstractBlock.Settings.create().mapColor(MapColor.CYAN).instrument(NoteBlockInstrument.BASEDRUM).strength(0.5F, 1.5F).luminance((state) -> 30) .sounds(BlockSoundGroup.AMETHYST_CLUSTER)), "deep_sea_lantern");
    public static final  Block DEEP_LANTERN = registerBlock(new Block(AbstractBlock.Settings.create().mapColor(MapColor.CYAN).instrument(NoteBlockInstrument.BASEDRUM).strength(0.5F, 1.5F).luminance((state) -> 30) .sounds(BlockSoundGroup.AMETHYST_CLUSTER)), "deep_lantern");
    public static final  Block SUPPORTER = registerBlock(new SupporterBlock(AbstractBlock.Settings.create().nonOpaque().mapColor(MapColor.CYAN).instrument(NoteBlockInstrument.BASEDRUM).luminance((state) -> 20).requiresTool().strength(1323123.5F, 1321236.5F).sounds(BlockSoundGroup.LANTERN)), "supporter");
