...
public class ModModelsRegister {
    ...
    public static void register() {
        ...
        EntityModelLayerRegistry.registerModelLayer(COMPULSION_SCYTHE, CompulsionScytheModel::getTexturedModelData);
        EntityModelLayerRegistry.registerModelLayer(OLD_LORDS_SPEAR, OldLordsSpearModel::getTexturedModelData);
